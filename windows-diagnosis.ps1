...
$providers = @('Microsoft-Windows-LxssManager','Microsoft-Windows-Hyper-V-Compute','Microsoft-Windows-Hyper-V-VMMS')
try {
...
# — filter out blank/whitespace-only names
$distros = (& wsl.exe -l --quiet) -replace "`0", "" |
